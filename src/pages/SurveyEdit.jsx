          ...
          <div style={{ padding:36 }}>
            ...
            {previewStep === -1 || previewStep === 0 && sv.welcome_message ? (
              ...
              <div style={{ textAlign:'center', paddingBottom:8 }}>
                <div style={{ marginBottom:16, color:"var(--coral)" }}><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l2.4 7.4L22 12l-7.6 2.6L12 22l-2.4-7.4L2 12l7.6-2.6L12 2z"/></svg></div>
